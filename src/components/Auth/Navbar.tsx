            ...
            <div className="container mx-auto px-4 lg:px-8 xl:max-w-7xl">
                <div className="flex justify-between py-4">
                    ...
                    <div className="flex items-center space-x-2 lg:space-x-5">
                        <nav className="hidden items-center space-x-2 lg:flex">
                            <a
                                href="#"
                                className="group flex items-center space-x-2 rounded-lg border border-indigo-100 bg-indigo-50 px-3 py-2 text-sm font-medium text-indigo-600 dark:border-transparent dark:bg-gray-700 dark:text-white"
                            >
                                <svg
                                    className="hi-mini hi-home inline-block h-5 w-5"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                    aria-hidden="true"
                            ...
                            <a
                                href="#"
                                className="group flex items-center space-x-2 rounded-lg border border-transparent px-3 py-2 text-sm font-medium text-gray-800 hover:bg-indigo-50 hover:text-indigo-600 active:border-indigo-100 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:active:border-gray-600"
                            >
                                <svg
                                    className="hi-mini hi-users inline-block h-5 w-5 opacity-25 group-hover:opacity-100"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                    aria-hidden="true"
                            ...
                            >
                                <svg
                                    className="hi-mini hi-briefcase inline-block h-5 w-5 opacity-25 group-hover:opacity-100"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                    aria-hidden="true"
                            ...
                            >
                                <svg
                                    className="hi-mini hi-chart-bar inline-block h-5 w-5 opacity-25 group-hover:opacity-100"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                    aria-hidden="true"
                                        ...
                                        <div className="space-y-1 p-2.5">
                                            <Menu.Item>
                                                {({ active }) => (
                                                    <a
                                                        href="#"
                                                        className={`group flex items-center justify-between space-x-2 rounded-lg border border-transparent px-2.5 py-2 text-sm font-medium ${active
                                                    ...
                                                    >
                                                        ...
                                                        <div className="inline-flex rounded-full border border-indigo-200 bg-indigo-100 px-1.5 py-0.5 text-xs font-semibold leading-4 text-indigo-700 dark:border-indigo-700 dark:bg-indigo-700 dark:text-indigo-50">
                                                            2
                                                        </div>
                                                    </a>
                                                )}
                ...
                <div className={`lg:hidden ${mobileNavOpen ? "" : "hidden"}`}>
                    <nav className="flex flex-col space-y-2 border-t py-4 dark:border-gray-700">
                        <a
                            href="#"
                            className="group flex items-center space-x-2 rounded-lg border border-indigo-50 bg-indigo-50 px-3 py-2 text-sm font-semibold text-indigo-600 dark:border-transparent dark:bg-gray-700/75 dark:text-white"
                        >
                            <svg
                                className="hi-mini hi-home inline-block h-5 w-5"
                                xmlns="http://www.w3.org/2000/svg"
